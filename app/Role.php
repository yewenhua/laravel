...
class Role extends Model
{
    ...
    public function permissions(){
        return $this->belongsToMany('App\Permission', 'permission_role', 'role_id', 'permission_id')->withPivot('add_permission', 'delete_permission', 'update_permission', 'read_permission');
    }
